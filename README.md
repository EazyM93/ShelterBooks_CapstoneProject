...
Se nell'elenco esiste un "ADMIN" il programma viene inizializzato normalmente, altrimenti genera un admin con informazioni di default e una password salvata nel file locale ${\color{yellow}env.properties}$.
...
- 🟧 "/clearCart" (POST)
  Svuota il carrello da tutti i libri.
  Li aggiunge alla lista dei libri comprati dall’utente.
  Crea l'ordine appena pagato
```
<a href="#">TORNA SU</a>
